...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MXPMainTabBarController *tabBarRootVC = [[MXPMainTabBarController alloc]init];
    
    //MXPNavigationController *nav = [[MXPNavigationController alloc]initWithRootViewController:root];//先将root添加在navigation上
